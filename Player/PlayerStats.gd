...
var level = 1
var level_exp = [0, 50, 75, 100, 150, 200, 700, 1200, 1700, 2200, 2700, 3200, 3700, 4200, 4700, 5200, 5700, 6200, 6700, 7200, 1]
...
var quest_val_list = [5, 10, 200, 30, 10, 1, 20, 30, 1]
var quest_type_list = [RAT, RAT, WHEAT, RAT, BAT, RAT, BAT, BAT, BOSS]
var quest_xp_list= [25, 150, 400, 300, 400, 0, 900, 1400, 1500]
var extra_hearts = 0
...
func _ready():
	label.visible = false
var active_monoliths = []

func save():
	var save_dict = {
		'active_monoliths' : active_monoliths,
...
func _process(_delta):
	$CanvasLayer/Achievement.visible = not get_tree().paused
	...
	if experience >= exp_to_next_level and level < 20:
		...
		var extra_text = ' '
		if level == 3:
				extra_text = 'You leveled up!  You also earned a skill point.  In the menu, you can spend it to level up your Magic, Strength, or Speed'
