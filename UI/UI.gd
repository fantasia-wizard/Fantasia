...
onready var magic_level = $TabContainer/Player/Skills/HBoxContainer/Magic/Level
onready var speed_level = $TabContainer/Player/Skills/HBoxContainer/Speed/Level2
onready var strength_level = $TabContainer/Player/Skills/HBoxContainer/Strength/Level3
...
func _on_CancelQuest_pressed() -> void:
	if PlayerStats.has_quest:
		$CancelQuestConfirm.popup_centered()


func _on_CancelQuestConfirm_confirmed() -> void:
	PlayerStats.has_quest = false
	PlayerStats.current_quest_progress = 0
